...
void Demo02::Prepare()
{
	...
	vector<shader_info> shader_infos2 = { { GL_VERTEX_SHADER, "shaders/demo02/TransformVertexShader.vertexshader" },
	{ GL_FRAGMENT_SHADER, "shaders/demo02/TextureFragmentShader.fragmentshader" } };
	...
	//void gltMakeSphere(GLfloat fRadius, GLint iSlices, GLint iStacks,
	//	std::vector<glm::vec3> & out_vertices,
	//	std::vector<glm::vec2> & out_uvs,
	//	std::vector<glm::vec3> & out_normals
	//	);
	MakeSphere(1.0f, 20, 20, vertices, uvs, normals);
